...
$this->title = 'Atualizar o aluno na disciplina: ' . $model->aluno_id_perfil;
$this->params['breadcrumbs'][] = ['label' => 'Aluno Disciplinas', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => $model->aluno_id_perfil, 'url' => ['view', 'aluno_id_perfil' => $model->aluno_id_perfil, 'disciplina_id' => $model->disciplina_id]];
